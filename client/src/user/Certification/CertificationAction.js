  ...
  if (data.length === 1) {
    return [
      [
        ...
        {
          text: data[0].startTime.substring(11, 19),
          fontSize: 11,
          alignment: "center",
        },
        {
          text: data[0].endTime.substring(11, 19),
          fontSize: 11,
          alignment: "center",
        },
    ...
    return data.map((item) => {
      return [
        ...
        {
          text: item.startTime.substring(11, 19),
          fontSize: 11,
          alignment: "center",
        },
        {
          text: item.endTime.substring(11, 19),
          fontSize: 11,
          alignment: "center",
        },
...
const CertificationAction = () => {
  ...
  const documentDefinition = {
    ...
    content: [
      ...
      //USER INFO
      {
        ...
        fontSize: 15,
        absolutePosition: { x: 237, y: 289 },
      },
      {
        text: data.data[0].department,
        fontSize: 15,
        absolutePosition: { x: 237, y: 325 },
      },
      {
        text: data.data[0].stdId,
        fontSize: 15,
        absolutePosition: { x: 237, y: 362 },
      },
      ...
      //TOTAL INFO
      {
        text: from + "~" + to,
        fontSize: 12,
        absolutePosition: { x: 237, y: 423.6 },
      }, //*******바꾸기 */
      {
        text: data.data.careTimes,
        fontSize: 12,
        absolutePosition: { x: 237, y: 445.8 },
      },
      {
        text: data.data.ordinaryTimes,
        fontSize: 12,
        absolutePosition: { x: 237, y: 467.5 },
      },
      {
        text: data.data.totalTime,
        fontSize: 12,
        absolutePosition: { x: 237, y: 489.5 },
        pageBreak: "after",
      },
  ...
  return (
    <div id="certificationAction">
      <div id="buttonWrap">
        <button id="pdfmake" className="user_btn_blue" onClick={func}>
          인증서 다운로드
        </button>
      </div>
